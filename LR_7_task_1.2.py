...
# Щоб візуалізувати межі, ми маємо створити сітку точок та обчислити модель на всіх вузлах сітки
# Визначимо крок сітки
step_size = 0.01

# Визначимо саму сітку і переконаємося у тому, що вона охоплює всі вхідні значення
